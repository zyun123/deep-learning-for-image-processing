...
def main():
    ...
    root_dir = "/911G/data/cure_images/一楼拷贝数据/dynamic_identfy/dynamic_middle_up_nei"
    ...
    with torch.no_grad():
        ...
        for img_path in glob.glob(os.path.join(root_dir,"*.jpg")):
            ...
            plt.show()
            # 保存预测的图片结果
            plot_img.save(f"/911G/data/cure_images/dynamic_up_nei/pred_all/{os.path.basename(img_path)}")
